...
bgzip filtered_d_spectabilis_Dgenome.recode.vcf
# bcftools stats filtered_d_spectabilis_Dgenome.recode.vcf.gz > filtered_d_spectabilis_STATS.txt
	
bcftools view -M 2 \
--output-type z \
--output biallelic_filtered_d_spectabilis_Dgenome.recode.vcf.gz \
filtered_d_spectabilis_Dgenome.recode.vcf.gz

# bcftools stats biallelic_filtered_d_spectabilis_Dgenome.recode.vcf.gz > \
# biallelic_filtered_${i}_STATS.txt

bcftools index biallelic_filtered_d_spectabilis_Dgenome.recode.vcf.gz
...
vcftools --gzvcf biallelic_filtered_d_spectabilis_Dgenome.recode.vcf.gz \
